...
SECRET_KEY = 'd7+5)2o7+n@qw75ap25yzhds-ji1af!c70o#r$!t9*l6y!m1-r'
...
MIDDLEWARE = [
    ...
    'django.contrib.flatpages.middleware.FlatpageFallbackMiddleware',# add middle ware class -sites 
]
